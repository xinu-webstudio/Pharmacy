...
const medicalInventoryRoute = createControllerRoutes("/medicalInventory", medicalInventoryController, {
...
const salePurchaseRoute = createControllerRoutes("/salePurchase", salePurchaseController, {
  getAll: [authMiddleware.authenticate],
  getById: [authMiddleware.authenticate],
  create: [authMiddleware.authenticate],
  update: [authMiddleware.authenticate],
...
const medicalProductRoute = createControllerRoutes("/medicalproduct", medicalProductController, {
  getAll: [authMiddleware.authenticate],
  getById: [authMiddleware.authenticate],
  create: [authMiddleware.authenticate],
  update: [authMiddleware.authenticate],
